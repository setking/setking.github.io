...
![](assets/img/redis/logic struct.jpg)
...
1. Compact行记录格式
   ...
   ![](assets/img/redis/Compact header.jpg)
...
2. Redundant行记录格式
   ...
   ![](assets/img/redis/Redundant.jpg)
   ...
   ![](assets/img/redis/Redundant header.jpg)
...
4. Compressed和Dynamic行记录格式
   ...
   ![](assets/img/redis/Compressed&Dynamic.jpg)
...
![](assets/img/redis/page size.jpg)

1. File Header
   File Header用来记录页的一些头信息，由下表8个部分组成，共占用38字节。
   File Header组成部分
   ![](assets/img/redis/file header.jpg)
   innodb中页的类型
   ![](assets/img/redis/file type.jpg)
2. Page Header
   该部分用来记录数据页的状态信息，由14个部分组成，共占56字节，如下图所示：
   ![](assets/img/redis/page header.png)
3. Infimum & Supremum Records
   ...
   ![](assets/img/redis/Infimum & Supremum Records.jpg)
