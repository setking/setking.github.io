...
1. redo
   ...
   ***log block***
   ...
   ![](assets/img/redis/log block header.jpg)
...
2. undo
   ...
   ***undo log格式***
   ...
   ![](assets/img/redis/insert undo log.jpg)
   ...
   ![](assets/img/redis/update undo log.jpg)
