---
title: TCP/IP详解 卷一 UDP:用户数据报协议
author: TCP/IP详解
date: 2025-10-11 11:33:00 +0800
categories: [学习]
tags: [学习]
pin: true
math: true
...
![](assets/img/tcp_ip/UDP封装.jpg)

#### UDP首部

UDP首部各字段如图：

![](assets/img/tcp_ip/UDP首部.jpg)
...
![](assets/img/tcp_ip/UDP伪首部格式.jpg)
...
![](assets/img/tcp_ip/ICMP不可达差错报文格式.jpg)
...
![](assets/img/tcp_ip/ICMP源站抑制差错报文.jpg)
