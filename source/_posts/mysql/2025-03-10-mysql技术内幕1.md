...
- [ ] **_Connection Pool_**：连接池组件

- [ ] **_Management Service & Utillties_**： 管理服务和工具组件

- [ ] **_SQL Interface_**：SQL接口组件

- [ ] **_Parser_**：查询分析器组件

- [ ] **_Optimizer_**：优化器组件

- [ ] **_Caches & Buffers_**：缓冲（Cache）组件

- [ ] **_Pluggable Storage Engines Memory,Index & Storage Management_**：插件式存储引擎
